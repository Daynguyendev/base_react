...
export default function Home() {
  ...
  return (
    // <div>
    //   <div style={{ justifyContent: 'center', alignItems: 'center', display: 'flex', fontSize: '40px', color: 'red', backgroundColor: 'white' }}>
    //     NHÀ MÁY
    //   </div>

    //   <main classNameName="flex min-h-screen items-center p-24" style={{ backgroundColor: 'white' }}>

    //     <h1 style={{ color: 'red', fontSize: '50px', paddingRight: '30px' }}>
    //       THI VNPT
    //     </h1>
    //     <button style={{ backgroundColor: 'cyan', border: '3px solid', padding: '5px' }} onClick={handleButtonClick} >Chấm công</button>
    //     {showTextFields && (
    //       <div>
    //         <form>
    //           <label>
    //             Công việc:
    //             <input type="text" name="cong_viec" placeholder='nhập công việc' />
    //           </label>
    //           <input type="submit" value="Submit" style={{ border: '3px solid' }} />
    //         </form>
    //       </div>
    //     )}
